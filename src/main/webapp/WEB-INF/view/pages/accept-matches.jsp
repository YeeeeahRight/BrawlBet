...
<html lang="<fmt:message key="html.lang"/>">
    <head>
        ...
        <link href="${pageContext.request.contextPath}/static/styles/accept-matches-body.css" rel="stylesheet" type="text/css">
    ...
    <body>
        <div class="container">
            ...
            <jsp:include page="../parts/accept-match-body.jsp"/>
        </div>
    </body>
</html>