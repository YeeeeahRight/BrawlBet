...
<html lang="<fmt:message key="html.lang"/>">
    <head>
        ...
        <link href="${pageContext.request.contextPath}/static/styles/finish-matches-body.css" rel="stylesheet" type="text/css">
    ...
    <body>
        <div class="container">
            ...
            <jsp:include page="../parts/finish-match-body.jsp"/>
        </div>
    </body>
</html>