...
<html lang="<fmt:message key="html.lang"/>">
    <head>
        ...
        <link href="${pageContext.request.contextPath}/static/styles/bookmaker-history.css" rel="stylesheet" type="text/css">
    ...
    <body>
        <div class="container">
            ...
            <jsp:include page="../parts/bookmaker-history-body.jsp"/>
        </div>
    </body>
</html>