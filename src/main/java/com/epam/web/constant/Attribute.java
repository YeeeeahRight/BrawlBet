...
public final class Attribute {
    public static final String MATCH_DTO = "matchDto";
    public static final String MATCH_DTO_LIST = "matchDtoList";
    ...
    public static final String FIRST_COEFFICIENT = "firstCoefficient";
